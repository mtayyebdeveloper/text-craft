  ...
  return (
    <>
        <div className="container pt-3">
          <h1 className={`text-${props.lightmood ==='light'?'dark':'light'}`}>{props.heading}</h1>
          <div className="mb-3">
            <textarea
              className={`form-control text-${props.lightmood ==='light'?'dark':'light'}`}
              style={{backgroundColor :props.lightmood==='light'?'white':'#042749'}}
              id="text"
              rows="5"
          ...
          <div className="submits-btn d-flex">
            ...
            <button disabled={text.length===0} onClick={copytext} className="btn btn-outline-primary me-2">
              Copy
            </button>
            <button
            disabled={text.length===0}
        ...
        <div className={`container mt-3 text-${props.lightmood === 'light'?'dark':'light'}`}>
          ...
          <p>{text ===""?"Enter somthing in the textbox above to preview here":text}</p>
        </div>
    </>
  );
}
